...
The task generates a bunch of files in the skippy directory:
```
ls -l skippy
...
The generated files are consumed by Skippy's [testing libraries](#junit) to make skip-or-execute predictions at test
