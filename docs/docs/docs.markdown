...
The Skippy class rule contains Skippy's Predictive Test Selection algorithm. It makes skip-or-execute decisions based on
a comparison between
- local state of the project and 
- the data in the `skippy` folder that was generated by Skippy's Skippy's Test Impact Analysis.
...
The Skippy extension contains Skippy's Predictive Test Selection algorithm. It makes skip-or-execute decisions based on
a comparison between
- local state of the project and
