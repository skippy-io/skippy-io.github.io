...
* [Skippy's Predictive Test Selection](#skippys-predictive-test-selection)
  * [JUnit 4](#junit-4)
    * [Install Skippy](#install-skippy-junit-4)
    * [Enable Predictive Test Selection](#enable-predictive-test-selection-junit-4)
  * [JUnit 5](#junit-5)
    * [Install Skippy](#install-skippy-junit-5)
    * [Enable Predictive Test Selection](#enable-predictive-test-selection-junit-5)
    * [Unsupported Features](#unsupported-features-junit-5)
...
|----------|--------------|--------------|
| ≥ 0.0.24 | 4.12 or later | 5.4 or later |
...
Add the Skippy rule to your test:
```groovy
...
The Skippy rule contains Skippy's Predictive Test Selection algorithm. The algorithm makes skip-or-execute
predictions based on
